...
is_ffmpeg_read = False
is_process_single = False
is_process_multi = True
is_ray = False

if is_ffmpeg_read is True:
    process1 = (
        ffmpeg
...
if __name__ == "__main__":
    ...
    for idx in range(video_src.num_frames):
        ...
        if is_process_multi is True:
            img_dst.proc_enqueue(_list_img=[frame_src], _path_img=os.path.join(path_img_dst, 'frame'), _postifx_num=idx)
